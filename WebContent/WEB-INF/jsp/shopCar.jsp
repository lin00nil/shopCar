	...
	<head>
		...
		<script type="text/javascript">
			...
			var addFun = function(id, num, type,storage){
				...
				switch (type){
					case 1: // 增加一个
						window.location.href = "updateCar?id=" + id + "&buyNum=" + (buyNum+1);
						break;
					case 2: // 减少一个
						window.location.href = "updateCar?id=" + id + "&buyNum=" + (buyNum-1);
						break;
	        			...
	        			<c:forEach items="${shopCars}"  var="shopCar">
							<div class="shoppingcart_promotions_01">
								<ul class="shoppingcart_list">
									...
									<li class="row44"><span>￥<fmt:formatNumber value="${shopCar.article.price*shopCar.article.discount}"  pattern="0.00">${shopCar.article.price*shopCar.article.discount}</fmt:formatNumber></span></li>
									<li class="row55">
