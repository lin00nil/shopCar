...
function header(name){
	...
	str += "			<a title=\"http://gz.gec-edu.org/?gzbdgzbdyueqianpc23\" href=\"http://gz.gec-edu.org/?gzbdgzbdyueqianpc23\">联系我们!</a>";
	str += "		</span>";
	str += "	</li>";
	str += "</ul>";
	str += "<ul class=\"fr lh\">";
	if (name == null || name == "" || name.length == 0){
		str += "	<li>";
		str += "		<span>";
		str += "			[<a href=\"loginView\">登录</a>]";
		str += "			[<a href=\"registerView\">免费注册</a>]";
		str += "		</span>";
		str += "	</li>";
	}else{
		str += "	<li>";
		...
		str += "		</span>：您好!&nbsp;&nbsp;";
		str += "		[<a href=\"loginout\">退出</a>]";
		str += "	</li>";
	}
	str += "    <li>&nbsp;[<a href=\"showShopCarItem\">我的购物车</a>]</li>";
	str += "	<li>&nbsp;[<a href=\"showOrder\">我的订单</a>]</li>";
	str += "	<li>";
	str += "		<span>";
	...
	str += "	<a title=\"广州粤嵌教育-购物商城\" href=\"indexServlet\">";
	str += "	<em>";
